...
def quem_somos():
    ...
    print("será possivel conectar o usuário a pets disponíveis dentro da sua região.")
    ...
    print("para que possamos garantir a auntenticidade das informações e evitar")
